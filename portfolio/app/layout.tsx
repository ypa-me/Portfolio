...
export default function RootLayout({
  ...
  <Link href="/blog" className="relative bg-white/1 font-mono text-xs w-auto h-auto text-center p-2 backdrop-blur-0.5 border border-white/20 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_0_20px_rgba(0,0,0,0.4)] ring-1 ring-white/5 ring-inset rounded-md overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:bg-red-500/50 hover:border-white/30 hover:backdrop-blur-xl hover:shadow-2xl hover:shadow-red-500/20">
    Blog 
  </Link>
